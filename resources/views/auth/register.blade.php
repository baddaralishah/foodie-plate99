                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('about') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea rows="3" class="form-control" placeholder="Add something about you" name="about"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea rows="3" class="form-control" placeholder="Enter your address" name="address"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('contact') ? ' has-error' : '' }}">
                            <label for="contact" class="col-md-4 control-label">Enter Contact Number</label>
